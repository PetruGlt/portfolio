...
const translations = {
    ro: {
        ...
        'skills.languages': '<i class="fas fa-code"></i> Limbaje de Programare',
        'skills.frameworks': '<i class="fas fa-layer-group"></i> Frameworks & Librării',
        'skills.tools': '<i class="fas fa-tools"></i> Tools & Cloud',
        'skill.tag.beginner': 'Începător',
        'skill.tag.intermediate': 'Intermediar',
        'skill.tag.advanced': 'Avansat',
        'filter.all': 'Toate',
    ...
    en: {
        ...
        'video.here': 'here',
        'skills.title': 'Skills',
        'skills.languages': '<i class="fas fa-code"></i> Programming Languages',
        'skills.frameworks': '<i class="fas fa-layer-group"></i> Frameworks & Libraries',
        'skills.tools': '<i class="fas fa-tools"></i> Tools & Cloud',
        'skill.tag.beginner': 'Beginner',
        'skill.tag.intermediate': 'Intermediate',
        'skill.tag.advanced': 'Advanced',
        'filter.all': 'All',
